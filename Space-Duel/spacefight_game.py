...
BULLET_HIT_SOUND = pygame.mixer.Sound('Assets/hit_sound.wav')
BULLET_FIRE_SOUND = pygame.mixer.Sound('Assets/fire_sound.wav')
WINNING_SOUND = pygame.mixer.Sound('Assets/winning_sound.wav')
